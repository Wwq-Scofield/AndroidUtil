...
public class ThreadManager {
    ...
    private static class ExecutorHolder {
        ...
        private static ExecutorService mExecutor = new ThreadPoolExecutor(Runtime.getRuntime().availableProcessors(),
                64, 2L, TimeUnit.SECONDS, new SynchronousQueue<Runnable>(), new ThreadPoolExecutor.CallerRunsPolicy());
    }
     ...
     *
     * @param task         要执行的任务
     * @param initialDelay 首次延迟时间，单位毫秒
     * @param period       周期时间，单位毫秒
     * @return ScheduledFuture
     * @throws NullPointerException     如果task为Null
     * @throws IllegalArgumentException 如果period小于等于0
     */
